...
| ---------------------------------| ----------------------------------------| -------------------------------------| -----------------------------------| ----------------------------------------| ---------------------------|---------------------------|
| ***General***                        | ***owned by Fonta1n3***   | ***owned by BlockchainCommons***             |***owned by zkSNACKs***|***owned by Katana Cryptographic***   |**owned by Bluewallet Services, S.R.L., 3 shareholders/developers?**|**owned by Crypto Advance - [founder](https://github.com/moritzwietersheim)**|
| [Open Source License](./Legend.md#Open-Source-License)  | [GPLv3](https://github.com/Fonta1n3/FullyNoded/blob/master/LICENSE.md)                                         | [BSD-2](https://github.com/BlockchainCommons/GordianWallet-iOS/blob/master/LICENSE)                  | [MIT](https://github.com/zkSNACKs/WalletWasabi/blob/master/LICENSE.md)                                |[Unlicense](https://github.com/Samourai-Wallet/samourai-wallet-android/blob/develop/LICENSE)     |[MIT](https://github.com/BlueWallet/BlueWallet/blob/master/LICENSE)|[MIT](https://github.com/cryptoadvance/specter-desktop/blob/master/LICENSE)|
| [Coordinator to be trusted](./Legend.md#Coordinator-to-be-trusted)               | No                                     | No        |No|Yes|No|No|
| [Devices](./Legend.md#Devices)             |  Mobile  (iOS only) and Desktop (MacOS only)                                 | Mobile (iOS only) and Desktop (MacOS only)       |Desktop (Mac and Windows) |Mobile (iOS/Android)|Mobile (iOS/Android) and Desktop (Mac and Windows)|Desktop (Mac and Windows)|
| [Net available](./Legend.md#Net-available)                 | **Main**, Test, Regtest, LN | Test, Regtest | **Main**, Test, Regtest | **Main**, Test | **Main**, LN|**Main**, Test|
...
| Feature / topic                  | Fully Noded                             | Gordian Wallet                       | Wasabi Wallet                           | Samourai Wallet                           | Blue Wallet   |Specter Wallet    |
| [Buy and sell bitcoin](./Legend.md#Buy-and-sell-bitcoin)        | No                                      | No              |||Yes, p2p exchange no KYC|No|
| [Signs psbt with](./Legend.md#Signs-psbt-with)                  | Root xprv                               | Account based xprvs                  ||| TBW  |Yes|                                          |
...
| [Uses hot wallets on your node](./Legend.md#Uses-hot-wallets-on-your-node)    | Yes                                     | No                                   |Yes|Yes| Yes                                               |No|
| [Decentralized identity creation]((./Legend.md#Decentralized-identity-creation))  | No                                      | Yes                                  | No| No| No|No|
| [Developer community](./Legend.md#Developer-community)         | One lead | One lead | | |3 developers||
| **[Type of wallet](./Legend.md#Type-of-wallet)**               | **Multi-purpose for power user**        | **Dedicated, with ease of use in mind** |**Coinjoin**|**Coinjoin**|**Simple**| **Multi-purpose for intermediate user**|
| [Difference](./Legend.md#Difference)                    | a remote control for your node          | a wallet                             |a coin mixing privacy wallet|a coin mixing privacy wallet| a simple wallet available on many devices|connects many hardware wallets|
