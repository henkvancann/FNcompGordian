...
| [Devices](./Legend.md#Devices)             |  Mobile  (iOS only) and Desktop (MacOS only)                                 | Mobile (iOS only) and Desktop (MacOS only)       |Desktop (Mac and Windows) |Mobile (iOS/Android)|Mobile (iOS/Android) and Desktop (Mac and Windows)nO|
